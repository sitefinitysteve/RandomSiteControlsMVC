...
Object(vue__WEBPACK_IMPORTED_MODULE_0__["createApp"])(app).mount('#app');
...
function createRootCodegen(root, context) {
    ...
    if (children.length === 1) {
        ...
        root.codegenNode = createVNodeCall(context, helper(FRAGMENT), undefined, root.children, patchFlag + (( true) ? ` /* ${patchFlagText} */` : undefined), undefined, undefined, true);
    }
    else ;
}
...
const transformFor = createStructuralDirectiveTransform('for', (node, dir, context) => {
    ...
    return processFor(node, dir, context, forNode => {
        ...
        forNode.codegenNode = createVNodeCall(context, helper(FRAGMENT), undefined, renderExp, fragmentFlag +
            (( true) ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__["PatchFlagNames"][fragmentFlag]} */` : undefined), undefined, undefined, true /* isBlock */, !isStableFragment /* disableTracking */, node.loc);
        return () => {
...
function compileToFunction(template, options) {
    ...
    const { code } = Object(_vue_compiler_dom__WEBPACK_IMPORTED_MODULE_2__["compile"])(template, Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__["extend"])({
        hoistStatic: true,
        onError(err) {
            if ((true)) {
                const message = `Template compilation error: ${err.message}`;
                const codeFrame = err.loc &&
                    Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__["generateCodeFrame"])(template, err.loc.start.offset, err.loc.end.offset);
...
module.exports = __webpack_require__(/*! C:\Github\RandomSiteControlsMVC\Demo\ResourcePackages\RSC\assets\src\js\app.js */"./assets/src/js/app.js");
